...
struct AnimateAccountDeletionPolicy {
    struct Copy {
    ...
    static func canUnlinkCurrentApp(from summary: AccountSummary, currentAppId: String = "animateav", suiteAppId: String = "avapps") -> Bool {
