...
struct AnimateAccountDeletionScreen: View {
    @Environment(\.dismiss) private var dismiss
    @StateObject private var viewModel: AnimateAccountDeletionViewModel

    init(viewModel: AnimateAccountDeletionViewModel) {
