...
enum AnimateCreateAvailabilityCopy {
    ...
    static var mediaMissingVideo: String { L10n.string("create.availability.mediaMissingVideo") }
    ...
    static var videoDirectionMissingVideo: String { L10n.string("create.availability.storyMissingVideo") }
    ...
    static var finalRenderMissingVideo: String { L10n.string("create.availability.finalRenderMissingVideo") }
