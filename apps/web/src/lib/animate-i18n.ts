...
const en = {
  ...
  gallery: {
    ...
    confirmClearLocal: "Clear this downloaded video from this browser?",
  ...
  inProgress: {
    ...
    delete: "Delete",
    clearLocal: "Clear local",
    confirmClearLocal: "Clear this local job from this browser?",
    confirmDelete: "Delete this active Animate AV job?",
    defaultTitle: "Animate AV video",
  ...
  login: {
    ...
    comingSoonBody: "We are preparing a guided workspace for turning a source image into animated video with calm review and Avi close by.",
    cta: "Sign in",
...
export const animateTranslations: Record<AppsAvLocale, AnimateText> = {
  ...
  es: {
    ...
    gallery: {
      ...
      confirmClearLocal: "Borrar este video descargado de este navegador?",
    ...
    inProgress: {
      ...
      delete: "Eliminar",
      clearLocal: "Borrar local",
      confirmClearLocal: "Borrar este trabajo local de este navegador?",
      confirmDelete: "Eliminar este trabajo activo de Animate AV?",
      defaultTitle: "Video de Animate AV",
    ...
    login: {
      ...
      comingSoonBody: "Estamos preparando un espacio guiado para convertir una imagen fuente en video animado con revisión tranquila y Avi cerca.",
      cta: "Iniciar sesión",
  ...
  fr: {
    ...
    inProgress: {
      ...
      confirmClearLocal: "Effacer ce travail local de ce navigateur ?",
      confirmDelete: "Supprimer ce travail Animate AV actif ?",
    ...
    login: {
      ...
      comingSoonBody: "Nous préparons un espace guidé pour transformer une image source en vidéo animée, avec une révision calme et Avi à proximité.",
      cta: "Se connecter",
    ...
    gallery: {
      ...
      clearLocal: "Effacer localement",
      confirmClearLocal: "Effacer cette video telechargee de ce navigateur ?",
  ...
  de: {
    ...
    inProgress: {
      ...
      confirmClearLocal: "Diesen lokalen Job aus diesem Browser entfernen?",
      confirmDelete: "Diesen aktiven Animate AV Job löschen?",
      defaultTitle: "Animate AV Video",
      realtimeTitle: "Realtime-Status",
    ...
    login: {
      ...
      comingSoonBody: "Wir bereiten einen geführten Arbeitsbereich vor, der ein Quellbild ruhig mit Avi in ein animiertes Video führt.",
      cta: "Anmelden",
    ...
    gallery: {
      ...
      clearLocal: "Lokal entfernen",
      confirmClearLocal: "Dieses heruntergeladene Video aus diesem Browser entfernen?",
  ...
  ca: {
    ...
    inProgress: {
      ...
      confirmClearLocal: "Esborrar aquest treball local d'aquest navegador?",
      confirmDelete: "Eliminar aquest treball actiu d'Animate AV?",
    ...
    login: {
      ...
      comingSoonBody: "Estem preparant un espai guiat per convertir una imatge font en vídeo animat amb revisió tranquil·la i Avi a prop.",
      cta: "Inicia sessió",
    ...
    gallery: {
      ...
      clearLocal: "Esborra local",
      confirmClearLocal: "Esborrar aquest video descarregat d'aquest navegador?",
