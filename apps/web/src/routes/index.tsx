      ...
      <SignedIn>
        <AppShell accountArea={<AccountUserButton />} footerLabels={text.footer} labels={shellLabels} navLinks={navLinks} product={productConfig}>
          <section className="grid gap-6 lg:grid-cols-[1fr_22rem]">
            <Card className="animate-canvas gap-0 overflow-hidden rounded-[1.5rem] border-[#e5c1c7] p-6 py-6 shadow-lg shadow-[#7b233f]/8 sm:p-8 sm:py-8">
            ...
            <Card className="gap-0 overflow-hidden rounded-[1.5rem] border-[#e5c1c7] bg-[#20242e] p-0 text-white shadow-lg shadow-[#7b233f]/14">
              ...
              <img className="mt-auto h-56 w-full object-cover object-bottom" src={animateBrandAssets.onboarding} alt="" />
            </Card>
          </section>
        </AppShell>
      </SignedIn>
