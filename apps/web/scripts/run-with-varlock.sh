...
profile="${ANIMATEAV_INFISICAL_PROFILE:-local}"
if [ "${1:-}" = "--profile" ]; then
  profile="${2:-}"
  shift 2
fi
...
export_from_varlock "ANIMATEAV_API_BASE_URL" "VITE_ANIMATEAV_API_BASE_URL" optional
export_from_varlock "ANIMATEAV_CONVEX_URL" "VITE_ANIMATEAV_CONVEX_URL" optional
export_from_varlock "ANIMATEAV_TERMS_URL" "VITE_ANIMATEAV_TERMS_URL" optional
export_from_varlock "ANIMATEAV_PRIVACY_URL" "VITE_ANIMATEAV_PRIVACY_URL" optional
export_from_varlock "ANIMATEAV_WEBAPP_COMING_SOON" "VITE_ANIMATEAV_WEBAPP_COMING_SOON" optional
...
export_from_varlock "ANIMATEAV_SUPPORT_EMAIL" "VITE_ANIMATEAV_SUPPORT_EMAIL" optional
export_from_varlock "ANIMATEAV_OPEN_SOURCE_URL" "VITE_ANIMATEAV_OPEN_SOURCE_URL" optional
