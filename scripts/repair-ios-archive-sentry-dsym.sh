...
usage() {
  cat <<'USAGE'
Usage:
  scripts/repair-ios-archive-sentry-dsym.sh --archive <AnimateAV.xcarchive>

Generates the dSYM for Xcode's Sentry.framework stub inside an Animate AV iOS
...
sentry_binary="$archive_path/Products/Applications/AnimateAV.app/Frameworks/Sentry.framework/Sentry"
